...
from CruellaRobot import OWNER_ID, SUPPORT_CHAT
from CruellaRobot.events import register
from CruellaRobot import telethn
...
async def lego(event):
    ...
    try:
        ...
        fillcolor = "black"
        shadowcolor = "blue"
        fnt = glob.glob("./KaizuryuBot/resources/fonts/*")
        ...
        await telethn.send_file(
            event.chat_id,
            file=fname,
            caption=f"ʟᴏɢᴏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ {dispatcher.bot.username}",
        )
        await pesan.delete()
