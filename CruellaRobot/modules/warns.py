...
import telegram
from CruellaRobot import TIGERS, WOLVES, dispatcher
from CruellaRobot.modules.disable import DisableAbleCommandHandler
from CruellaRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from CruellaRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from CruellaRobot.modules.helper_funcs.string_handling import split_quotes
from CruellaRobot.modules.log_channel import loggable
from CruellaRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Kaizuryu's sticker
        keyboard = None
        log_reason = (
