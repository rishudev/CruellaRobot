...
import CruellaRobot.modules.sql.notes_sql as sql
from CruellaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from CruellaRobot.__main__ import DATA_IMPORT
from CruellaRobot.modules.helper_funcs.chat_status import user_admin
from CruellaRobot.modules.helper_funcs.alternate import typing_action

# from KaizuryuBot.modules.rules import get_rules
import CruellaRobot.modules.sql.rules_sql as rulessql

# from KaizuryuBot.modules.sql import warns_sql as warnssql
import CruellaRobot.modules.sql.blacklist_sql as blacklistsql
from CruellaRobot.modules.sql import disable_sql as disabledsql

# from KaizuryuBot.modules.sql import cust_filters_sql as filtersql
# import KaizuryuBot.modules.sql.welcome_sql as welcsql
import CruellaRobot.modules.sql.locks_sql as locksql
from CruellaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("KaizuryuBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KaizuryuBot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KaizuryuBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KaizuryuBot{}.backup".format(chat_id))  # Cleaning file
