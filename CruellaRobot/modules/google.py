...
import urllib
from CruellaRobot import telethn as tbot
import glob
import io
import os
import re
...
from CruellaRobot.events import register
...
@register(pattern=r"^/reverse|/grs|/pp|/p(?: |$)(\d*)")
...
__help__ = """
 ...
 ❍ {dispatcher.bot.first_name} <query>*:* {dispatcher.bot.first_name} answers the query
  💡Ex: `{dispatcher.bot.first_name} where is India?`
"""
