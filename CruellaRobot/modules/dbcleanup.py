...
import CruellaRobot.modules.sql.global_bans_sql as gban_sql
import CruellaRobot.modules.sql.users_sql as user_sql
from CruellaRobot import DEV_USERS, OWNER_ID, dispatcher
