...
from CruellaRobot.__main__ import STATS, TOKEN, USER_INFO
import CruellaRobot.modules.sql.userinfo_sql as sql
from CruellaRobot.modules.disable import DisableAbleCommandHandler
from CruellaRobot.modules.sql.global_bans_sql import is_user_gbanned
from CruellaRobot.modules.sql.afk_sql import is_afk, check_afk_status
from CruellaRobot.modules.sql.users_sql import get_user_num_chats
from CruellaRobot.modules.helper_funcs.chat_status import sudo_plus
from CruellaRobot.modules.helper_funcs.extraction import extract_user
from CruellaRobot import telethn as KaizuryuTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/AsukaUpdates/5">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Umm... yeah, I only trust Kaizuryu to set my bio.")
            return
